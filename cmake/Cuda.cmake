...
function(detect_cuDNN)
#  set(CUDNN_ROOT "" CACHE PATH "CUDNN root folder")
  set(CUDNN_ROOT /home/nsl/Downloads/cudnn_v3/)
  set(CUDNN_INCLUDE /home/nsl/Downloads/cudnn_v3/include)
#  find_path(CUDNN_INCLUDE cudnn.h
#          PATHS ${CUDNN_ROOT}/include $ENV{CUDNN_ROOT}
#          DOC "Path to cuDNN include directory." )
#  MESSAGE(${CUDNN_ROOT}/include)
#  MESSAGE(${CUDNN_INCLUDE})
...
#        DOC "Path to cuDNN library.")
  set(CUDNN_LIBRARY /home/nsl/Downloads/cudnn_v3/lib64)
...
if(USE_CUDNN)
  ...
  set(CUDNN_ROOT /home/nsl/Downloads/cudnn_v3/)
  set(CUDNN_INCLUDE /home/nsl/Downloads/cudnn_v3/include)
  set(CUDNN_LIBRARY /home/nsl/Downloads/cudnn_v3/lib64/libcudnn.so)
  if(HAVE_CUDNN)
    add_definitions(-DUSE_CUDNN)
    include_directories(SYSTEM ${CUDNN_INCLUDE})
    list(APPEND Caffe_LINKER_LIBS ${CUDNN_LIBRARY})
    MESSAGE(STATUS ${CUDNN_INCLUDE})
    MESSAGE(STATUS ${CUDNN_LIBRARY})
#    include_directories(SYSTEM /home/nsl/Downloads/cudnn_v3/include)
#    list(APPEND Caffe_LINKER_LIBS /home/nsl/Downloads/cudnn_v3/lib64/libcudnn.so)
  endif()
endif()
